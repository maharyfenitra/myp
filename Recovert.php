...
<script src="jquery-ui/jquery-ui.js"></script>
	...
	<td style="color: red;">*<?php db_get_text($lang, 'all', 'customer_error_login'); ?>*</td>
									...
									<tr>
										<td></td>
										<td><a href='Customer.php?forget_password__=1'
									...
									<?php  }?>
									<?php if(isset($_GET['recuper'])&&$_GET['recuper']==1){
										include 'customer/library/mail.php';

										$check=new Checker();
										$compte=$_POST['compte'];
										if($check->isMail($compte)){
											$m=new ForgetPassword($compte);
											//echo $compte.'</br>';
										}else{
											$customer=new Customer($compte,null,null,null);
											$m=new ForgetPassword($customer->getMail());
											//echo $customer->getMail().'</br>';
										}
										?>
									<tr>
										<td></td>
