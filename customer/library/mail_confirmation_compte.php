...
class Mail_Confirmation_Compte{
...
$title=db_get_text_($lang, 'all', 'activation_title');
...
$message_2=db_get_text_($lang, 'all', 'activation_compte_message');
...
$sujet = db_get_text_($lang, 'all', 'activation_title');
