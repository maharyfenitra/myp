...
$action = (isset($_GET['action'])&&isValidField($_GET['action']) && $_GET['action'] != '') ? $_GET['action'] : 'view';
...
?>
 <tr class="content"> 
  ...
  <td><a href="<?php echo $productUrl; ?>"><?php echo $pd_name; ?></a></td>
   <td align="right"><?php echo displayAmount($ta_price); ?></td>
  ...
  <td align="right"><?php echo displayAmount($ta_price * $ct_qty); ?></td>
