...
?>
  <tr height="50">
	<td>
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" name="frmDelete" id="frmDelete">
...
<table width = "100%" bgcolor ="#EFEDED"  cellpadding ="5">
 ...
 <script>
  ...
  <input name="btnUpdate" type="submit" id="btnUpdate" value="<?php echo db_return_text($lang,'store','cart_update'); ?>" style=" background:url(images/Button_Update.png);background-size:150px 20px; background-repeat:no-repeat; background-position:center; color:#dddddd; font-size:11px; border:0; align:center; width: 150px; margin-top: 5px;" class="box"></td>
</table>
