...
if (isCartEmpty()) {
	...
	if ($step == 1) {
		...
		// send the order details to paypal
			...
			break;
                    case 'creditcard':
                        $includeFile = 'paypal/creditcard.php';
			break;
                    case 'cod':
...
<script language="JavaScript" type="text/javascript" src="php_includes/checkout.js"></script>


<?php

require_once "php_includes/$includeFile";
