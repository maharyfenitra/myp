...
//    $catImage = uploadImage('fleImage', SRV_ROOT . 'images/category/');
    ...
    $sql   = "INSERT INTO tbl_category (cat_parent_id, cat_reference, cat_image, cat_display_order) 
              VALUES ($parentId, '$name', '$catImage', $displayOrder)";
...
//        _deleteImage($catId);
    ...
    $sql    = "UPDATE tbl_category 
               SET cat_reference = '$name', cat_image = $catImage, cat_active=$active, cat_display_order=$displayOrder
               WHERE cat_id = $catId";
