...
?>	 
  ...
  <tr> 
   ...
   <td class="content"><input name="txtPriceRetail" type="text" id="txtPriceRetail" size="10" maxlength="7" class="box" onKeyUp="checkNumber(this);"> </td>
  </tr>
  <tr> 
   <td width="150" class="label">Image</td>
   <td class="content"> <input name="imageName" type="text" id="imageName" class="box"> 
