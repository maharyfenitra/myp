...
//	$thumbnail = $images['thumbnail'];
	...
	$sql   = "INSERT INTO tbl_product (cat_id, pd_reference, pd_price, pd_image, pd_thumbnail, pd_date)
	          VALUES ('$catId', '$name', $price, '$mainImage', '$mainImage', NOW())";
...
//		$thumbnail = 'pd_thumbnail';
	...
	$sql   = "UPDATE tbl_product 
	          SET cat_id = $catId, pd_reference = '$name', pd_price = $price, 
			      pd_image = $mainImage, pd_thumbnail = $mainImage
