...
//	 if ($weight > 0) {
		 ...
		 $product_item_list .= "<tr><td>$id<input type='hidden' name='pi_id[]' value='$id'></td><td><input type='text' name='pi_flavor[]' value='$flavor' size='8'></td><td><input type='text' name='pi_flavor_display_order[]' value='$flavor_display_order' size='5'></td><td><input type='text' name='pi_stock_qty[]' value='$stock_qty' size='5'></td><td><input type='text' name='pi_weight[]' value='$weight' size='5'></td><td><input type='text' name='pi_shipping_weight[]' value='$shipping_weight' size='5'></td></tr>"; 
...
?> 
<form action="processProduct.php?action=cloneProduct&productId=<?php echo $productId; ?>" method="post" enctype="multipart/form-data" name="frmAddProduct" id="frmAddProduct">
 <p align="center" class="formTitle">Clone Product</p>
...
?>	 
  ...
  <tr> 
   ...
   <td class="content"> <input name="txtName" type="text" class="box" id="txtName" value="<?php echo $pd_reference; echo '_COPY'; ?>" size="50" maxlength="100"></td>
...
echo "<tr><td colspan=1 class='label'>".$type['label']."</td><td colspan=1 align='right' class='content'>".$productinfo->getPrice($admin->getIdTypeFor($type['label']))."</td></tr>";
  ...
  <tr> 
   ...
   <td class="content"> <input name="imageName" type="text" id="imageName" class="box" size="60" value="<?php echo $pd_thumbnail;?>">
<!--   <td class="content"> <input name="fleImage" type="file" id="fleImage" class="box"> -->
<?php
	if ($pd_thumbnail != '') {
?>
    <br>
    <img src="<?php echo PRODUCT_IMAGE_DIR . $pd_thumbnail; ?>"> &nbsp;&nbsp;
    <?php
	}
?>    
    </td>
...
?>
 ...
 <p align="center"> 
  <input name="btnCloneProduct" type="button" id="btnCloneProduct" value="Clone Product" onClick="checkAddProductForm();" class="box">
